const dataSources = [
    { id: 'wts_en', name: 'Japanese Property Registration', url: '/api/xlsx/war_time_streets_inUse.xlsx' },
    { id: '1938_en', name: '1938 Street Index (Batch 1)', url: '/api/xlsx/1938_Street_index_inUse.xlsx' }
];
